 ...
 ******************************************************************************
 *	Measuring the High Speed Internal (HSI)
 *	Demonstrate that the output of a clock signal (MCO1) from the STM32F4 uM
 *	to an external pin (specifically PA8) so that it can be observed or used
 *	externally - e.g., with an oscilloscope s
 ******************************************************************************
 */
#include<stdint.h>
